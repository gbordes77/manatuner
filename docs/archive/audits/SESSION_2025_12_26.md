...
**Where Recommendations Went**: Already available in Analysis tab → Recommendations sub-tab
...
- "Archétype de Deck" → "Deck Archetype"
- "Stratégie Optimale" → "Optimal Strategy"
- "Score Moyen (7 cartes)" → "Average Score (7 cards)"
- "GARDE ÉVIDENT" → "SNAP KEEP"
- And 30+ more...
...
```
🎲 Feature: Advanced Mulligan Strategy Tab with Archetype Support
   - 1511 lines added
   - Full Monte Carlo simulation
   - Archetype-aware scoring

🔧 Fix: Tooltips language (French → English)
   - All UI text in English

🎨 UI: Dashboard cleanup (remove recommendations)
