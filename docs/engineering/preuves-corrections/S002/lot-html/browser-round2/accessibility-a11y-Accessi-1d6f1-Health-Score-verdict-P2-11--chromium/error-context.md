...
- Location: tests/e2e/accessibility/a11y.spec.js:108:7
...
```ts
  ...
  42  |   })
  43  | 
  44  |   test('Analyzer with fixed card metadata — no critical/serious axe', async ({ page }) => {
  45  |     test.setTimeout(90000)
  46  |     await page.goto('/analyzer')
  47  |     await page.getByRole('textbox', { name: /Paste your decklist/ }).fill('24 Mountain\n36 Lightning Bolt')
  ...
  111 |     await page.getByRole('textbox', { name: /Paste your decklist/ }).fill('24 Mountain\n36 Lightning Bolt')
