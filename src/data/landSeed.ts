...
const SEED_DATA: Record<string, SeedLandData> = {
  ...
  // Remaining MKM surveil duals (complete cycle for landUtils non-regression)
  'Elegant Parlor': {
    category: 'utility',
    produces: ['R', 'W'],
    producesAny: false,
  ...
  // Horizon — Grove of the Burnwillows (missing from horizon block)
  ...
  // Utility lands previously only in hardcoded landUtils list
  'Gemstone Mine': {
    category: 'utility',
    produces: ['W', 'U', 'B', 'R', 'G'],
    producesAny: true,
  ...
  // ---------------------------------------------------------------------------
  // Non-regression: lands present in legacy hardcoded lists (T03) but not yet
  // in the original seed. Minimal correct metadata — category + produces.
  // ---------------------------------------------------------------------------
  'Arcane Sanctum': {
    category: 'utility',
    produces: ['W', 'U', 'B'],
