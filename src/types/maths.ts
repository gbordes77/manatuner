...
import type { ManaColor, MTGFormat } from './index'
export type { ManaColor } from './index'
...
// ManaColor and MTGFormat are now imported from ./index

// Frank Karsten's magic constants
export const MAGIC_CONSTANTS = {
  // Probability thresholds
  EXCELLENT_THRESHOLD: 0.95, // 95%+ probability
  GOOD_THRESHOLD: 0.9, // 90%+ probability (Karsten standard)
  ACCEPTABLE_THRESHOLD: 0.8, // 80%+ probability
  POOR_THRESHOLD: 0.6, // 60%+ probability
...
export const KARSTEN_TABLES: Record<number, Record<number, number>> = {
  ...
  1: {
    // Single colored symbol (e.g., R, 1B, 2W)
    1: 14,
    2: 13,
    3: 12,
    4: 10,
