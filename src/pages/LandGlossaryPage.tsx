...
const LAND_CATEGORIES: LandCategory[] = [
  {
    ...
    whyPowerful:
      "The absolute best lands ever printed. They produce 2 colors, always enter untapped, have basic land types (fetchable!), and have ZERO downside. Reserved List means they'll never be reprinted, making them the gold standard all other duals are measured against.",
    examples: [
      'Underground Sea',
      'Tropical Island',
      'Volcanic Island',
  ...
  },
  {
    ...
    whyPowerful:
      'The most versatile lands in Magic. They thin your deck (improving draw quality), shuffle away bad cards, trigger landfall multiple times, and most importantly can find Shocklands or Original Duals giving you access to any color combination.',
    examples: [
      'Scalding Tarn',
      'Flooded Strand',
      'Polluted Delta',
  ...
  },
  {
    ...
    whyPowerful:
      'The backbone of competitive Modern/Pioneer manabases. They have basic land types (fetchable!), provide 2 colors, and you choose whether to pay life for tempo or enter tapped when life matters more.',
    examples: [
      'Sacred Foundry',
      'Hallowed Fountain',
      'Steam Vents',
  ...
  },
  {
    ...
    whyPowerful:
      "Excellent in aggressive and low-curve decks. Early game they fix your mana, late game when you're flooded you can cash them in for a card. The card draw option makes them never truly dead.",
    examples: [
      'Sunbaked Canyon',
      'Fiery Islet',
      'Silent Clearing',
  ...
  },
  {
    ...
    whyPowerful:
      "Great budget option and synergize perfectly with Shocklands (which have basic types). Reliable untapped mana once you've established your manabase.",
    examples: [
      'Clifftop Retreat',
      'Glacial Fortress',
      'Dragonskull Summit',
  ...
  },
  {
    ...
    whyPowerful:
      "Always untapped, always available. The 1 life cost is minimal in most matchups, and you can tap for colorless when you don't need colored mana to save life.",
    examples: [
      'Battlefield Forge',
      'Caves of Koilos',
      'Shivan Reef',
  ...
  },
  {
    ...
    whyPowerful:
      "Cards like Starting Town are excellent in aggressive decks - untapped turns 1-3 when it matters, and the 'downside' of entering tapped later rarely affects aggro strategies.",
  ...
  },
  {
    ...
    whyPowerful:
      'Excellent color fixing for 3+ color decks. Having basic land types makes them fetchable. The cycling ability provides late-game utility.',
    examples: [
      "Raffine's Tower",
  ...
  },
  {
    ...
    whyPowerful:
      "Provide unique effects that can't be replicated by spells. Cavern of Souls makes creatures uncounterable, Mutavault is a creature land, etc.",
  ...
  },
  {
    ...
    whyPowerful:
      'Immune to non-basic land hate (Blood Moon, Back to Basics). Always untapped, no life cost. Essential for fetch targets and checkland enablers.',
...
export const LandGlossaryPage: React.FC = () => {
  ...
  const deckTips = [
    {
      type: 'Aggro',
      desc: 'Prioritize untapped lands. Fetchlands, Fastlands, and Rainbow Lands.',
      color: '#f44336',
    },
    {
      type: 'Midrange',
      desc: 'Balance Fetchlands + Shocklands, add Checklands and basics.',
      color: '#ff9800',
    },
    {
      type: 'Control',
      desc: 'Can afford some taplands. Triomes become more playable.',
      color: '#2196f3',
    },
  ]
        ...
        <Box sx={{ mb: 5 }}>
          ...
          <Box sx={{ textAlign: 'center' }}>
            ...
            <Typography variant="h6" color="text.secondary" sx={{ maxWidth: 700, mx: 'auto' }}>
              Understanding land types is crucial for building an optimal manabase. Ranked from most
              to least powerful for competitive play.
            </Typography>
          </Box>
        </Box>
      </AnimatedContainer>
                  ...
                  <CardContent sx={{ p: 3 }}>
                    ...
                    >
                      <Typography
                        variant="subtitle2"
                        fontWeight={700}
                        sx={{ color: getRankColor(category.rank), mb: 0.5 }}
                      >
                        Why it's powerful:
                      </Typography>
                      <Typography variant="body2">{category.whyPowerful}</Typography>
                    </Paper>
